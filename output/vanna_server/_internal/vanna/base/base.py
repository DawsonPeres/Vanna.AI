...
class VannaBase(ABC):
    ...
    def generate_plotly_code(
        ...
        # user_message="Can you generate the Python plotly code to chart the results of the dataframe? " \
        ...
        user_message = "Can you generate the Python plotly code to chart the results of the dataframe? With Height=410 and Width=420" \
                       "And Try to use Chinese," \
                       "Assume the data is in a pandas dataframe called 'df'. If there is only one value in the dataframe, " \
                       "use an Indicator. Respond with only Python code. Do not answer with any explanations -- just the code."
